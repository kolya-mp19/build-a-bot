<template>
  <div class="part"  v-bind:class="position">
...
export default {
  // все свойства которые мы используем вне элемента - должны экспортировать
  // в т.ч. позиционирование, которое задается относительно другого компонента
  props: {
    parts: {
      type: Array,
      required: true,
